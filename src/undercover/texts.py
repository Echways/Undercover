...
class Reveal:
    ...
    LAST_VIEWED_CAPTION: Final = "👁 {name}: карточка открыта. Все посмотрели — пора обсуждать."
...
class Errors:
    ...
    UNEXPECTED: Final = "⚠️ Что-то пошло не так. Попробуйте ещё раз — партия никуда не делась."
    STALE_BUTTON: Final = (
